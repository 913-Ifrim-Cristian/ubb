...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_WeatherApp_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_WeatherApp_t qt_meta_stringdata_WeatherApp = {
    {
QT_MOC_LITERAL(0, 10) // "WeatherApp"
...
const QMetaObject WeatherApp::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_WeatherApp.offsetsAndSize,
    qt_meta_data_WeatherApp,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_WeatherApp_t
