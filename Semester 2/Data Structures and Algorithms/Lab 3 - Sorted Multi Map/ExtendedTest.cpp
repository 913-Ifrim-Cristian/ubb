...
void testJumpForward(Relation r) {
    ...
    itsmm.jumpForward(5);
    assert(itsmm.valid());
    assert(itsmm.getCurrent().first == 0 && itsmm.getCurrent().second == 84);

    itsmm.jumpForward(30);
    assert(itsmm.getCurrent().first == 1);

    itsmm.jumpForward(50);
    assert(itsmm.getCurrent().first == 2);
