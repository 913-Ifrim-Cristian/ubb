...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_AdminGUI_t, stringdata0) + ofs), len 
...
const QMetaObject AdminGUI::staticMetaObject = { {
    ...
    qt_meta_stringdata_AdminGUI.offsetsAndSize,
    qt_meta_data_AdminGUI,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_AdminGUI_t
