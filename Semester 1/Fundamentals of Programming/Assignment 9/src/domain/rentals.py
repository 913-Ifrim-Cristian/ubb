...
class Rental:
    ...
    def __str__(self):
        format = "%d/%m/%Y"
        return f"Rental ID: {self.__rentID}, Book ID: {self.__book}, Client ID: {self.__client}, Rent date: {self.__rentDate.strftime(format)}, Return date: {self.__returnDate.strftime(format)}"
